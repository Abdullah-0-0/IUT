...
class TestHistoriqueTrie {
    ...
    @Test
    fun testHisto_utilisantPaquesGregorienne() {
        val paques: Paques = PaquesGregorienne()

        val annees = listOf(
            2022, 125, 1492, 2019, 2018, 1583, 2016,
            1492, 23, 2017, 2002, 1582, 2018
        )
        for (annee in annees) {
            try {
                paques.calculeDatePaques(annee)
            } catch (e: Exception) {
                //
            }
        }
    ...
    @Test
    fun testHisto_utilisantPaquesJulienne() {
        val paques: Paques = PaquesJulienne()

        val annees = listOf(
            2022, 125, 1492, 2019, 2018, 1583, 2016, 1492, 23,
            2017, 2002, 1582, 2018
        )
        for (annee in annees) {
            try {
    ...
    @Test
    fun testHistoAutrement_utilisantPaquesJulienne() {
        val paques: Paques = PaquesJulienne()
    ...
    @Test
    fun testHisto_ATTENTIION_AU_EFFET_DE_BORD() {
        val paques: Paques = PaquesGregorienne()
