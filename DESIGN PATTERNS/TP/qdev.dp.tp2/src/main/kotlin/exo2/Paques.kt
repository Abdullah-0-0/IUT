...
interface Paques {
    ...
    /**
     * Donne la liste de toutes les dates de Pâques calculées jusque-là,
     * à l'aide de l'objet courant
     *
    ...
    /**
     * Donne la liste de toutes les dates de Pâques calculées jusqu'ici à l'aide de
     * l'objet courant ; la liste résultat sera triée par mois, puis par jour,
     * puis par année
     *
    ...
    /**
     * donne la liste des certaines dates de Pâques calculées à l'aide de
